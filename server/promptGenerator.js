...
async function generatePrompt() {
    try{
        ...
        const input = "Please generate a unique prompt in the style of the popular jackbox game quiplash. Please only return the prompt with no other text. Keep it PG-13. Make it a fill-in-the-blank."
