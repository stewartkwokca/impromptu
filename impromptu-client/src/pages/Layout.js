        ...
        {/* <div class="flex w-[40%]">
          <form class="mx-auto my-auto w-full">   
              ...
              <div class="relative bg-white w-full">
                  ...
                  <div className="flex flex-row bg-blue-500 w-full h-full">
                    <Dropdown options={options} onChange={()=>{}} value={defaultOption} placeholder="Select an option" className="mt-1"/>
                    <input type="search" id="default-search" class="block w-96 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mr-0" placeholder="Search Prompts, Users" required />
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-0">Search</button>
                  </div>
          ...
          <nav class="items-center justify-between flex-wrap bg-black p-6 w-64 h-full fixed top-16 left-0 pb-24 pt-0">
            <div class="flex flex-col flex-grow lg:flex lg:items-left lg:w-auto w-full h-full justify-between">
              <div class="flex flex-col text-sm lg:flex-grow w-full">
                ...
                <Link to="/search" className="block mt-2 text-lg font-bold lg:inline-block text-white hover:text-white mr-4">
                  Search
                </Link>
              </div>
